...
function shrake_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'shrake' ),
		'social'  => __( 'Social Menu', 'shrake' ),
	) );
...
add_image_size( 'homepage-featured-thumb', 200, 200, true );
...
function shrake_register_widget_areas() {
	register_sidebar( array(
		'id'            => 'footer-widgets',
		'name'          => __( 'Footer Area', 'shrake' ),
		'description'   => __( 'Add widgets here to appear at the bottom of every page.', 'shrake' ),
